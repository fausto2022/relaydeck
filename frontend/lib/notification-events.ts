...
export const NOTIFICATION_EVENT_OPTIONS: NotificationEventOption[] = [
  ...
  { id: "main_pool_unavailable", label: "主站分组无可用账号", description: "主站分组可调度账号数降为 0 时提醒。", events: ["main_pool_unavailable"] },
  { id: "main_pool_recovered", label: "主站分组恢复可用", description: "主站分组重新出现可调度账号时提醒。", events: ["main_pool_recovered"] },
